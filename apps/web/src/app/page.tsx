      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <header className="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" className="hidden sm:flex gap-2" asChild>
              <Link
                href="https://github.com/Itz-Agasta/LogPose"
                target="_blank"
        ...
        <main className="flex-1">
          ...
          <section className="container mx-auto flex flex-col items-center justify-center px-4 py-24 text-center sm:py-32 lg:px-8">
            <Badge
              variant="outline"
              className="mb-6 rounded-full border-primary/50 bg-primary/10 px-4 py-1.5 text-primary backdrop-blur-sm"
            >
            ...
            <p className="mb-10 max-w-2xl text-lg text-muted-foreground sm:text-xl">
              LogPose orchestrates specialized AI agents to analyze, visualize, and interpret your
              maritime and logistics data. Powered by DuckDB for lightning-fast analytics.
            </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-12 px-8 text-base backdrop-blur-sm bg-background/10 hover:bg-background/20"
                asChild
              >
                <Link href="https://github.com/Itz-Agasta/LogPose">View Source</Link>
              </Button>
            </div>
          </section>
          ...
          <section id="features" className="container mx-auto px-4 py-24 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Built with a modern stack designed for performance and reliability.
              </p>
            </div>
          ...
          <section id="agents" className="container mx-auto px-4 py-24 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <p className="mt-4 text-muted-foreground">
                Specialized AI workers aimed at specific tasks to deliver comprehensive insights.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border/50 bg-background/30 p-8 md:p-12 backdrop-blur-md">
              <div className="mx-auto max-w-4xl text-center">
                ...
                <div className="space-y-4 text-lg text-muted-foreground text-left mx-auto max-w-2xl">
                  <p>
                    LogPose was born from the need to simplify complex data interactions in the
                    maritime and logistics sector. Navigating through terabytes of data shouldn't
                    require deep technical expertise in SQL or programming.
                  </p>
                  <p>
                    Our mission is to empower decision-makers with a natural language interface that
                    puts the power of advanced analytics at their fingertips. By combining
                    state-of-the-art LLMs with high-performance DuckDB analytics, we're redefining
        ...
        <footer className="border-t border-border/40 bg-background/50 backdrop-blur-sm">
          <div className="container mx-auto flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0 px-4 sm:px-6 lg:px-8">
            <p className="text-center text-sm leading-loose text-muted-foreground md:text-left">
              Built by the LogPose team. The source code is available on{" "}
