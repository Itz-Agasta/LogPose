    ...
    >
      ...
      <div className="flex min-h-0 w-full flex-1 flex-col overflow-y-auto p-5 pt-2">
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              style={{
                backgroundColor:
                  filters.selectionTool === "lasso" ? "var(--accent)" : "var(--background)",
                border: "1px solid var(--border)",
                color: "var(--foreground)",
              }}
            >
            ...
            <button
              ...
              style={{
                backgroundColor:
                  filters.selectionTool === "grid" ? "var(--accent)" : "var(--background)",
                border: "1px solid var(--border)",
                color: "var(--foreground)",
              }}
            >
            ...
            <button
              ...
              style={{
                backgroundColor:
                  filters.selectionTool === "globe" ? "var(--accent)" : "var(--background)",
                border: "1px solid var(--border)",
                color: "var(--foreground)",
              }}
            >
        ...
        <div className="mb-6">
          ...
          {/* Status */}
          <div className="mb-4">
            <span className="mb-2 block font-medium text-xs" style={{ color: "var(--primary)" }}>
              Status
            </span>
            <div className="space-y-2">
                ...
                <div className="flex items-center justify-between" key={option.id}>
                  <label className="flex cursor-pointer items-center gap-2">
                    <div
                      ...
                      onClick={() =>
                        handleStatusChange(option.id as keyof SidebarFilters["status"])
                      }
                      style={{
                        border: "1px solid var(--border)",
                    ...
                    >
                      {filters.status[option.id as keyof SidebarFilters["status"]] && (
                        <span className="text-xs" style={{ color: "var(--primary-foreground)" }}>
                          ✓
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center justify-between" key={option.id}>
                  <label className="flex cursor-pointer items-center gap-2">
                    <div
                      className="flex h-4 w-4 items-center justify-center rounded-sm"
                      onClick={() =>
                        handleNetworkChange(option.id as keyof SidebarFilters["network"])
                      }
                      style={{
                        border: "1px solid var(--border)",
            ...
            {overlayOptions.map((option) => (
              <div className="flex items-center justify-between" key={option.id}>
                ...
                <Switch
                  ...
                  onCheckedChange={() =>
                    handleOverlayChange(option.id as keyof SidebarFilters["overlays"])
                  }
                />
              </div>
            ))}
