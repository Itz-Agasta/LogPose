...
type PropsWithRenderFunction<ComponentProps = unknown, RenderPropProps = never> = ComponentProps & {
...
export type PropsWithChildrenOrRenderFunction<ComponentProps, RenderPropProps = never> =
...
> = PropsWithChildrenOrRenderFunction<BaseProps<ComponentProps>, RenderPropProps>;
