...
export type ReasoningInfoTriggerProps = BaseProps<React.ButtonHTMLAttributes<HTMLButtonElement>>;

/**
 * Trigger button for expanding/collapsing reasoning details.
 */
export const ReasoningInfoTrigger = React.forwardRef<HTMLButtonElement, ReasoningInfoTriggerProps>(
  ({ asChild, onClick, children, ...props }, ref) => {
    const { isExpanded, setIsExpanded, detailsId } = useReasoningInfoRootContext();
